                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            ...
                            <?php if (isset($_SESSION['errors'])):
                                ...
                                ?>
                                <form id="contactForm"  action="./controllers/contactController.php" method="POST" data-sb-form-api-token="API_TOKEN">
                                    <!-- Name input-->
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="submitButton" type="submit" class="form-control">Submit</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
